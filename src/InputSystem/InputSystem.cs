...
public static class InputSystem
{
    ...
    private static KeyStates GetKey(KeyCode key)
    {
    ...
    private static bool IsKeyDownState(KeyCode key)
    {
        return KeyStates.Down == (GetKey(key) & KeyStates.Down);
    }

    private static bool IsKeyToggledState(KeyCode key)
    {
        return KeyStates.Toggled == (GetKey(key) & KeyStates.Toggled);
    }

    //Get the current keys that were pressed
    public static List<KeyCode> GetInputs()
    {
        return keys;
    }
